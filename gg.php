...
<div id="">
    ...
    <div class="container clearfix">
            ...
            <!-- MENU BLOCK -->
            <div id="undefined-sticky-wrapper" class="sticky-wrapper" style=""><div class="menu_block">
            
                <!-- CONTAINER -->
                <div class="container clearfix"><a href="javascript:void(0)" class="menu_toggler"><i class="fa fa-align-justify"></i></a>
                    
                    <!-- LOGO -->
                    <div class="logo">
                        <a href="http://hellobrand.com/"><img src="http://hellobrand.com/skin/frontend/rwd/glammy/images/media/logo.png" alt=""></a>
                    </div><!-- //LOGO -->
